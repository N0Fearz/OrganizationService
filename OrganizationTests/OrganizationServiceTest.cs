...
public class OrganizationServiceTest
{
    ...
    public OrganizationServiceTest()
    {
        ...
        _logPublisher = Substitute.For<ILogPublisher>();
        var migrationService = new MigrationService(_configuration, _logPublisher);
        _organizationRepository = Substitute.For<IOrganizationRepository>();
        _organizationService = new OrganizationService.Services.OrganizationService(_organizationRepository, migrationService, _logPublisher);
    }
    // [Fact]
